...
Use `grep_search` for exact text matches, `semantic_search` for conceptual searches, `file_search` for finding files by name pattern. Read only the most relevant parts.
